                                ...
                                <table class="table report-item">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Land Size: <span class="highlight_value">{{ $property['plotAreaInSqMt'] }}
                                                    Sq. Mtr.</span></td>
                                            <td>Land Value: <span
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#submitflatFormBtn').click(function(e) {
                ...
                if (!$('#area').val()) {
                    $('#area').next('.text-danger').text('Please enter the area.');
                    isValid = false;
                }
                if (!$('#unit').val()) {
                    $('#unit').next('.text-danger').text('Please select unit.');
                    isValid = false;
                }
