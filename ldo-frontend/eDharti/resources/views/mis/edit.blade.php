            ...
            <div id="stepper3" class="bs-stepper gap-4 vertical">
                ...
                <div class="bs-stepper-content">
                    <form method="POST" action="{{ route('mis.update', $propertyDetail->id) }}">
                        ...
                        <input type="hidden" id="serviceType" name="serviceType" value="{{ $additionalData[0] }}">
                        <input type="hidden" id="modalId" name="modalId" value="{{ $additionalData[1] }}">
                        <input type="hidden" id="applicantNo" name="applicantNo" value="{{ $additionalData[2] }}">
                        <input type="hidden" id="masterId" name="masterId" value="{{ $additionalData[3] }}">
                        <input type="hidden" id="newPropertyId" name="newPropertyId" value="{{ $additionalData[4] }}">
                        <input type="hidden" id="oldPropertyId" name="oldPropertyId" value="{{ $additionalData[5] }}">
                        <input type="hidden" id="sectionCode" name="sectionCode" value="{{ $additionalData[6] }}">
                        <!--End -->
