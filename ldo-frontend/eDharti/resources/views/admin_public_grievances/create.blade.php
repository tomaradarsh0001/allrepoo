    ...
    <div class="card-body">
        ...
        <form id="grievanceForm" action="{{ isset($grievance) ? route('grievance.update', $grievance->id) : route('grievance.storeInitial') }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="grievanceForm" class="grievanceForm m-3" style="border: 1px solid #ddd; padding: 5px; margin-bottom: 10px; border-radius: 5px;">
                ...
                <div class="row m-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile" id="mobile" maxlength="10" class="form-control numericOnly" value="{{ old('mobile', $grievance->mobile ?? '') }}"> 
                ...
                <!-- Proceed Button -->
                <button type="button" class="btn btn-primary mx-4 mb-4 mt-2" id="ProceedButton">{{ isset($grievance) ? 'Update Grievance' : 'Proceed' }}</button>
            </div>
        </form>
    </div>
</div>
