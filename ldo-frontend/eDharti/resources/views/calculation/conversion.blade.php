            ...
            <div class="col lg-12 d-none mt-2" id="calculation">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td> <span id="equation"></span> <b class="float-right"><small>[<span id="formula"></span>]</small></b></td>
                    </tr>
                    <tr>
                        <th>Conversion Charges</th>
                        <td id="charges" class="charges"></td>
                    </tr>
                    <tr>
                        <th><span id="additionalChargesLabel"></span></th>
                        <td class="charges"><span id="additionalCharges"></span><b class="float-right"><small>[<span id="additionalFormula"></span>]</small></b></td>
                    </tr>
                    <tr>
                        <th>Payable Charges</th>
                        <td id="total" class="charges"></td>
                    </tr>
