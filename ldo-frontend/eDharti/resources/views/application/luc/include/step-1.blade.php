<div class="mt-3">
    <div class="container-fluid">
        <div class="row g-3 mb-2 mt-3">
            ...
            <div class="col-lg-4 col-12">
                <div class="form-group form-box">
                    ...
                    <input type="text" name="lucblockno" id="lucblockno" class="form-control alphaNum-hiphenForwardSlash" placeholder="Block No." readonly>
            ...
            <div class="col-lg-4 col-12">
                <div class="form-group form-box">
                    ...
                    <input type="text" name="lucplotno" id="lucplotno"
                        class="form-control plotNoAlpaMix" placeholder="Property/Plot No." readonly>
        ...
        <div class="row g-3 mb-2 mt-3">
            ...
            <div class="col-lg-3 col-12">
                <div class="form-group">
                    <label for="lucpropertytypeto" class="form-label">Change to Property Type<span class="text-danger">*</span></label>
            ...
            <div class="col-lg-3 col-12">
                <div class="form-group">
                    <label for="lucpropertysubtypeto" class="form-label">Change to Property Sub Type<span class="text-danger">*</span> </label>
