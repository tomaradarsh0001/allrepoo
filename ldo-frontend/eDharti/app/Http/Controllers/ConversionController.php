...
class ConversionController extends Controller
{
    ...
    public function chargesForProperty(Request $request)
    {
        ...
        if ($propertyId != "") {
            ...
            if (strpos($propertyId, '_')) {
                ...
                if ($masterPropertyId != "" && $childPropertyId != "") {
                    ...
                    if (!empty($masterProperty) && !empty($childProperty)) {
                        ...
                        $allowAccess = $this->checkAccess($old_property_id);
                ...
                if (empty($masterProperty)) {
                    ...
                    $allowAccess = $this->checkAccess($childProperty->old_property_id);
                    ...
                    $allowAccess = $this->checkAccess($propertyId);
            ...
            return response()->json([
                ...
                'charges' => round($conversionCharges, 2),
    ...
    private function checkAccess($propertyId)
    {
        $user = Auth::user();
        if ($user->user_type == 'applicant') {
