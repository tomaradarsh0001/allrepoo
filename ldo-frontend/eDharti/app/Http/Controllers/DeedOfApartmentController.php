...
{
    public function deedOfApartmentStepFirstStore(Request $request)
    {
        ...
        try {
            ...
            if ($transactionSuccess) {
                $response = ['status' => true, 'message' => 'Details have been saved successfully', 'data' => $tempDOA];
            } else {
    ...
    public function deedOfApartmentStepFinalStore(Request $request)
    {
        ...
        $documentsRequired = array_keys(config('applicationDocumentType.DOA.Required'));
